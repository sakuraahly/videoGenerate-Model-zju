...
| 文件 | 执行方式 | 说明 |
|------|----------|------|
| video_minimax_h3_t2v.json | 本地 GPU | 文生视频 |
| video_minimax_h3_i2v.json | 本地 GPU | 首帧图生视频 |
| video_minimax_h3_r2v.json | 本地 GPU | 多参考图生视频 |
| video_minimax_h3_flf2v.json | 本地 GPU | 首末帧生视频 |
| api_minimax_h3_*.json | Comfy 云 | 需登录，非本地推理 |

**本地任务用 video_* 模板，无需登录。**
