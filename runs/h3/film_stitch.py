...
def stitch(segments: list, out: Path, width: int = 864, height: int = 480,
    ...
    try:
        ...
        for i, seg in enumerate(segments):
            ...
            normalize(sp, np_, width, height, fps)
...
def main() -> int:
    ...
    out = Path(args.out)
    stitch(segs, out, args.width, args.height, args.fps, args.keep_norm)
